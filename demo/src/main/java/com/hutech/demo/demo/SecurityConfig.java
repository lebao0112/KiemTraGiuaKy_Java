package com.hutech.demo.demo;

import com.hutech.demo.demo.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/products/edit/**", "/products/add", "/products/delete","/about/about")
                        .hasAnyAuthority("ADMIN") // Chỉ cho phép ADMIN truy cập.
                        .requestMatchers("/cart")
                        .hasAnyAuthority("USER") // Chỉ cho phép ADMIN truy cập.
                        .requestMatchers("/api/**")
